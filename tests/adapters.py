...
def run_linear(
    ...
    model.bias.data = torch.zeros(d_out)
...
def run_rope(
    ...
    rope = RotaryPositionEmbedding(d_k, theta, max_seq_len)
...
def run_train_bpe(
    ...
    **kwargs,
    ...
    # Call the train_bpe function to get vocab and merges
    vocab, merges = train_bpe(str(input_path), vocab_size, special_tokens, **kwargs)
